...
export async function connectDatabase() {
    try {
        ...
        await db.exec("CREATE TABLE IF NOT EXISTS categories (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, description TEXT, flagN BOOLEAN DEFAULT 1);");
        await db.exec("CREATE TABLE IF NOT EXISTS products (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, description TEXT, quantity INTEGER CHECK(quantity >= 0), categoryId INTEGER, flagN BOOLEAN DEFAULT 1, FOREIGN KEY (categoryId) REFERENCES categories(id));");
        await db.exec("CREATE TABLE IF NOT EXISTS receivers (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, description TEXT, flagN BOOLEAN DEFAULT 1);");
