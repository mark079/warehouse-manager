...
export async function connectDatabase() {
    try {
        ...
        await db.exec("CREATE TABLE IF NOT EXISTS transactions (id INTEGER PRIMARY KEY AUTOINCREMENT, type TEXT CHECK(type IN ('entry', 'exit')), receiverId INTEGER, letter INTEGER, observation TEXT, flagN BOOLEAN DEFAULT 1, datetime DATETIME DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (receiverId) REFERENCES receivers(id));");
